//altlvds_tx CBX_SINGLE_OUTPUT_FILE="ON" clk_src_is_pll="off" COMMON_RX_TX_PLL="OFF" CORECLOCK_DIVIDE_BY=2 DATA_RATE=""640.0 Mbps"" DESERIALIZATION_FACTOR=8 DIFFERENTIAL_DRIVE=0 IMPLEMENT_IN_LES="ON" INCLOCK_BOOST=0 INCLOCK_PERIOD=12500 INCLOCK_PHASE_SHIFT=0 INTENDED_DEVICE_FAMILY=""Cyclone IV E"" LPM_TYPE="altlvds_tx" NUMBER_OF_CHANNELS=1 OUTCLOCK_DIVIDE_BY=1 OUTCLOCK_DUTY_CYCLE=50 OUTCLOCK_MULTIPLY_BY=1 OUTCLOCK_PHASE_SHIFT=0 OUTCLOCK_RESOURCE="AUTO" OUTPUT_DATA_RATE=640 PLL_COMPENSATION_MODE="AUTO" PLL_SELF_RESET_ON_LOSS_LOCK="OFF" PREEMPHASIS_SETTING=0 REGISTERED_INPUT="TX_CLKIN" USE_EXTERNAL_PLL="OFF" USE_NO_PHASE_SHIFT="ON" VOD_SETTING=0 tx_coreclock tx_in tx_inclock tx_locked tx_out tx_outclock
...
module  mg1e22
	...
	wire  wire_mgl_prim1_tx_coreclock;
	wire  wire_mgl_prim1_tx_locked;
	wire  [0:0]   wire_mgl_prim1_tx_out;
	wire  wire_mgl_prim1_tx_outclock;

	altlvds_tx   mgl_prim1
	( 
	.tx_coreclock(wire_mgl_prim1_tx_coreclock),
	.tx_in(tx_in),
	.tx_inclock(tx_inclock),
	.tx_locked(wire_mgl_prim1_tx_locked),
	...
	defparam
		...
		mgl_prim1.inclock_period = 12500,
