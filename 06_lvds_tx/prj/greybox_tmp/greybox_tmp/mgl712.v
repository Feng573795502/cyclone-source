//altlvds_tx CBX_SINGLE_OUTPUT_FILE="ON" clk_src_is_pll="off" COMMON_RX_TX_PLL="OFF" CORECLOCK_DIVIDE_BY=2 DATA_RATE=""80.0 Mbps"" DESERIALIZATION_FACTOR=8 DIFFERENTIAL_DRIVE=0 IMPLEMENT_IN_LES="ON" INCLOCK_BOOST=0 INCLOCK_PERIOD=100000 INCLOCK_PHASE_SHIFT=8334 INTENDED_DEVICE_FAMILY=""Cyclone IV E"" LPM_TYPE="altlvds_tx" NUMBER_OF_CHANNELS=1 OUTCLOCK_DIVIDE_BY=1 OUTCLOCK_DUTY_CYCLE=50 OUTCLOCK_MULTIPLY_BY=1 OUTCLOCK_PHASE_SHIFT=8334 OUTCLOCK_RESOURCE=""Global clock"" OUTPUT_DATA_RATE=80 PLL_COMPENSATION_MODE="AUTO" PLL_SELF_RESET_ON_LOSS_LOCK="OFF" PREEMPHASIS_SETTING=0 REGISTERED_INPUT="TX_CLKIN" USE_EXTERNAL_PLL="OFF" USE_NO_PHASE_SHIFT="ON" VOD_SETTING=0 tx_in tx_inclock tx_out tx_outclock
...
module  mgl712
	...
	defparam
		...
		mgl_prim1.outclock_phase_shift = 8334,
		mgl_prim1.outclock_resource = ""Global clock"",
		mgl_prim1.output_data_rate = 80,
