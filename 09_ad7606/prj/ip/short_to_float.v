...
module  short_to_float_altbarrel_shift_uvf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //short_to_float_altbarrel_shift_uvf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  short_to_float_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //short_to_float_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  short_to_float_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //short_to_float_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  short_to_float_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	short_to_float_altpriority_encoder_3v7   altpriority_encoder10
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder10_q));
	short_to_float_altpriority_encoder_3e8   altpriority_encoder11
	( 
	.data(data[3:2]),
...
endmodule //short_to_float_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  short_to_float_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
...
endmodule //short_to_float_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  short_to_float_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	short_to_float_altpriority_encoder_6v7   altpriority_encoder8
	( 
	.data(data[3:0]),
...
endmodule //short_to_float_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  short_to_float_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	short_to_float_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder14_q),
	.zero(wire_altpriority_encoder14_zero));
	short_to_float_altpriority_encoder_6e8   altpriority_encoder15
	( 
	.data(data[7:4]),
...
endmodule //short_to_float_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  short_to_float_altpriority_encoder_rb6
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	short_to_float_altpriority_encoder_bv7   altpriority_encoder6
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder6_q));
	short_to_float_altpriority_encoder_be8   altpriority_encoder7
	( 
	.data(data[15:8]),
...
endmodule //short_to_float_altpriority_encoder_rb6

//synthesis_resources = lpm_add_sub 2 lpm_compare 1 reg 155 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  short_to_float_altfp_convert_p1n
	( 
	clock,
	dataa,
	result) ;
	...
	short_to_float_altbarrel_shift_uvf   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	short_to_float_altpriority_encoder_rb6   altpriority_encoder2
	( 
	.data(prio_mag_int_a),
...
endmodule //short_to_float_altfp_convert_p1n
//VALID FILE
...
module short_to_float (
	...
	short_to_float_altfp_convert_p1n	short_to_float_altfp_convert_p1n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
