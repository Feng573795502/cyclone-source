...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV E" DIRECTION="ADD" OPTIMIZE="AREA" PIPELINE=7 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 clock dataa datab result
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_altfp_add_sub_d1j
	( 
	clock,
	dataa,
	datab,
...
endmodule //fp_add_altfp_add_sub_d1j
//VALID FILE
...
module fp_add (
	...
	fp_add_altfp_add_sub_d1j	fp_add_altfp_add_sub_d1j_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.result (sub_wire0));
