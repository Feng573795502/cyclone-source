...
`endif
	...
	assign
		result = result_node,
		result_node = {((sel_node[2] & (((w_data126w[1] & w_sel127w[0]) & (~ (((w_data126w[0] & (~ w_sel127w[1])) & (~ w_sel127w[0])) | (w_sel127w[1] & (w_sel127w[0] | w_data126w[2]))))) | ((((w_data126w[0] & (~ w_sel127w[1])) & (~ w_sel127w[0])) | (w_sel127w[1] & (w_sel127w[0] | w_data126w[2]))) & (w_data126w[3] | (~ w_sel127w[0]))))) | ((~ sel_node[2]) & (((w_data125w[1] & w_sel127w[0]) & (~ (((w_data125w[0] & (~ w_sel127w[1])) & (~ w_sel127w[0])) | (w_sel127w[1] & (w_sel127w[0] | w_data125w[2]))))) | ((((w_data125w[0] & (~ w_sel127w[1])) & (~ w_sel127w[0])) | (w_sel127w[1] & (w_sel127w[0] | w_data125w[2]))) & (w_data125w[3] | (~ w_sel127w[0]))))))},
		sel_ffs_wire = {sel[2:0]},
		sel_node = {sel_ffs_wire[2], sel[1:0]},
		w_data125w = w_data96w[3:0],
		w_data126w = w_data96w[7:4],
		w_data96w = {data[7:0]},
		w_sel127w = sel_node[1:0];
endmodule //lvds_rx_mux

//synthesis_resources = lut 13 reg 28 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF"} *)
