//altlvds_tx CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" COMMON_RX_TX_PLL="OFF" CORECLOCK_DIVIDE_BY=2 DATA_RATE="163.84 Mbps" DESERIALIZATION_FACTOR=10 DEVICE_FAMILY="Cyclone 10 LP" DIFFERENTIAL_DRIVE=0 ENABLE_CLK_LATENCY="OFF" IMPLEMENT_IN_LES="ON" INCLOCK_BOOST=0 INCLOCK_DATA_ALIGNMENT="EDGE_ALIGNED" INCLOCK_PERIOD=61050 INCLOCK_PHASE_SHIFT=0 MULTI_CLOCK="OFF" NUMBER_OF_CHANNELS=1 OUTCLOCK_ALIGNMENT="EDGE_ALIGNED" OUTCLOCK_DIVIDE_BY=10 OUTCLOCK_DUTY_CYCLE=50 OUTCLOCK_MULTIPLY_BY=2 OUTCLOCK_PHASE_SHIFT=0 OUTCLOCK_RESOURCE="AUTO" OUTPUT_DATA_RATE=163 PLL_COMPENSATION_MODE="AUTO" PLL_SELF_RESET_ON_LOSS_LOCK="OFF" PREEMPHASIS_SETTING=0 REGISTERED_INPUT="OFF" USE_EXTERNAL_PLL="ON" USE_NO_PHASE_SHIFT="ON" VOD_SETTING=0 tx_in tx_inclock tx_out tx_syncclock CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//CBXI_INSTANCE_NAME="lvds_ip_auto_align_data_tranmit_auto_align_trans_inst_oserdes_ser_ins_altlvds_tx_ALTLVDS_TX_component"
...
module  oserdes_lvds_tx1_oserdes_ddio_out
	( 
	datain_h,
	datain_l,
	dataout,
...
endmodule //oserdes_lvds_tx1_oserdes_ddio_out
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  oserdes_lvds_tx1_oserdes_cmpr
	( 
	aeb,
	dataa,
...
endmodule //oserdes_lvds_tx1_oserdes_cmpr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  oserdes_lvds_tx1_oserdes_cmpr1
	( 
	aeb,
	dataa,
	datab) /* synthesis synthesis_clearbox=1 */;
...
`endif
	...
	assign
		...
		data_wire = {datab[2], dataa[2], datab[1], dataa[1], datab[0], dataa[0], (data_wire[6] ^ data_wire[7]), ((data_wire[2] ^ data_wire[3]) | (data_wire[4] ^ data_wire[5]))},
		eq_wire = aeb_result_wire;
endmodule //oserdes_lvds_tx1_oserdes_cmpr1

//synthesis_resources = lut 3 reg 3 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  oserdes_lvds_tx1_oserdes_cntr
	( 
	clock,
	q,
...
`endif
	...
	oserdes_lvds_tx1_oserdes_cmpr1   cmpr14
	( 
	.aeb(wire_cmpr14_aeb),
	.dataa(safe_q),
	.datab(modulus_bus));
	assign
		...
		updown_dir = updown;
endmodule //oserdes_lvds_tx1_oserdes_cntr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  oserdes_lvds_tx1_oserdes_shift_reg
	( 
	clock,
	data,
	load,
...
endmodule //oserdes_lvds_tx1_oserdes_shift_reg

//synthesis_resources = IO 1 lut 3 reg 33 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  oserdes_lvds_tx1
	( 
	tx_in,
	tx_inclock,
	tx_out,
...
`endif
	...
	oserdes_lvds_tx1_oserdes_ddio_out   ddio_out
	( 
	.datain_h(l_input),
	.datain_l(h_input),
	...
	oserdes_lvds_tx1_oserdes_cmpr   cmpr10
	( 
	.aeb(wire_cmpr10_aeb),
	.dataa(dffe4a),
	.datab(dffe8a));
	oserdes_lvds_tx1_oserdes_cmpr   cmpr9
	( 
	.aeb(wire_cmpr9_aeb),
	.dataa(dffe3a),
	.datab(dffe7a));
	oserdes_lvds_tx1_oserdes_cntr   cntr2
	( 
	.clock(fast_clock),
	.q(wire_cntr2_q),
	.updown(sync_dffe1a));
	oserdes_lvds_tx1_oserdes_shift_reg   shift_reg12
	( 
	.clock(fast_clock),
	...
	oserdes_lvds_tx1_oserdes_shift_reg   shift_reg13
	( 
	.clock(fast_clock),
